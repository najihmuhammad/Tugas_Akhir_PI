<?php
	...
	$query=mysql_query("select * from tabel_admin where  username='$username' and password='$password'");	 //melakukan pengampilan data dari database untuk di cocokkan
	...
	if($xxx==TRUE){ 		// melakukan pemeriksaan kecocokan dengan percabangan.
		...
		header("location:halperusahaan/halperusahaan.php");     // dan alihkan ke index.php
