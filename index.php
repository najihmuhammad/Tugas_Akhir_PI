...
<body id="page-top" class="index">
    ...
    <section class="success" id="login">
        <div class="container">
			...
			<div class="row">
				<h5 align="center"> Belum punya Akun?</h5> 
				<div>
					<p>
						<center>
							<a href="#portfolioModal2" data-toggle="modal" class="btn btn-lg btn-outline">DAFTAR</a>
						</center>
					</p>
				</div>
			</div>
				...
				<form class="form-horizontal" action="login.php" method="post">
					<div class="row control-group">
						<div class="form-group">
							...
							<input type="text"  name="username" class="form-control" placeholder="Username" id="username" required data-validation-required-message="Please enter your username.">
						</div>
					</div>
					<div class="row control-group">
						<div class="form-group">
							...
							<div class="row">
								<form method="post" action="" enctype="multipart/form-data">
									<div class="row">
										...
										<div>
											<input type="radio" name="Kelamin" value="L">Member
											<input type="radio" name="Kelamin" value="P">Perusahaan
										</div>
									</div>
									<div>
